...
//		try {
//			fs = new POIFSFileSystem(new FileInputStream("F:\\workbook.xls"));
...
//		System.out.println(msg);
	...
	public static void method2() throws Exception {
		...
		InputStream is = new FileInputStream("F:\\workbook.xls");
	...
	public static void method3() throws Exception {
		HSSFWorkbook wb = new HSSFWorkbook(new FileInputStream("F:\\workbook.xls"));
		HSSFSheet sheet = wb.getSheetAt(0);
